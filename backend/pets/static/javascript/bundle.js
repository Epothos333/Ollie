...
var _PetContainer = __webpack_require__(25);

var _PetContainer2 = _interopRequireDefault(_PetContainer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_PetContainer2.default, null), document.getElementById('root'));
...
*/
var aa=__webpack_require__(2),n=__webpack_require__(4),ba=__webpack_require__(8);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var _PetName = __webpack_require__(26);

var _PetName2 = _interopRequireDefault(_PetName);

var _PetBreed = __webpack_require__(29);

var _PetBreed2 = _interopRequireDefault(_PetBreed);

var _PetGender = __webpack_require__(30);

var _PetGender2 = _interopRequireDefault(_PetGender);

var _PetSpay = __webpack_require__(31);

var _PetSpay2 = _interopRequireDefault(_PetSpay);

var _SaveButton = __webpack_require__(32);
...
var PetContainer = function (_React$Component) {
	_inherits(PetContainer, _React$Component);

	function PetContainer() {
		_classCallCheck(this, PetContainer);

		var _this = _possibleConstructorReturn(this, (PetContainer.__proto__ || Object.getPrototypeOf(PetContainer)).call(this));

		_this.state = {};
		return _this;
	}

	_createClass(PetContainer, [{
		key: 'updaetStateFromCallback',
		value: function updaetStateFromCallback(keyValuePair) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_Banner2.default, { saved: this.state.saved }),
				_react2.default.createElement(
					'form',
					{ onSubmit: function onSubmit(e) {
							e.preventDefault();
						} },
					_react2.default.createElement(_PetName2.default, { callback: function callback(name) {
							_this2.updaetStateFromCallback(name);
						} }),
					_react2.default.createElement(_PetBreed2.default, { name: this.state.name, callback: function callback(breed) {
							_this2.updaetStateFromCallback(breed);
						} }),
					_react2.default.createElement(_PetGender2.default, { name: this.state.name, breed: this.state.breed, callback: function callback(gender) {
							_this2.updaetStateFromCallback(gender);
						} }),
					_react2.default.createElement(_PetSpay2.default, { name: this.state.name, gender: this.state.gender, callback: function callback(spay) {
							_this2.updaetStateFromCallback(spay);
						} }),
					_react2.default.createElement(_SaveButton2.default, { data: this.state, callback: function callback(saved) {
							return _this2.setSaveStatus(saved);
						} })
				)
			);
		}
...
function PetName(props) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement('input', { onChange: onTextChange }),
		'.'
	);
}
...
function PetBreed(props) {
	...
	var visibility = props.name ? 'visible' : 'hidden';
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement('input', { onChange: onTextChange, placeholder: 'breed' }),
		'.'
	);
}
...
function PetGender(props) {
	...
	var visibility = props.breed ? 'visible' : 'hidden';
	var style = { visibility: visibility };
...
PetGender.propTypes = {
	breed: _propTypes.string,
	callback: _propTypes.func,
	name: _propTypes.string
};

exports.default = PetGender;
...
function PetGender(props) {
	...
	var visibility = props.gender ? 'visible' : 'hidden';
	var style = { visibility: visibility };
...
function PetGender(props) {
	...
	function saveDog() {
		_axios2.default.post('api/pets/', props.data).then(function () {
			props.callback(true);
		}).catch(function () {
...
function PetBreed(props) {
	...
	if (props.saved) {
		content = _react2.default.createElement(
			'h4',
			null,
			'We have everything we need! You are done here.'
		);
	} else if (props.saved === false) {
		content = _react2.default.createElement(
			'h4',
			null,
			'Looks like something went wrong. Did you fill out all of the forms?'
		);
	}
